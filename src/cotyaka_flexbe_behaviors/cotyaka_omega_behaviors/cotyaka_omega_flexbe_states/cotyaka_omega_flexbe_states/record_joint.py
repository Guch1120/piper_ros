...
class RecordJoint(EventState):
    ...
    def __init__(self,joint_state_topic='/joint_states',joint_names=None):
    ...
    def on_enter(self, userdata):
        ...
        Logger.loginfo('RecordJoint: Recorded {}: {}'.format(len(self._recorded_joint_list),joint_values))
    ...
    def _get_current_joint_values(self):
        ...
        for joint_name in self._joint_names:
            ...
            Logger.logwarn('RecordJoint: Required joint "{}" is not in JointState.'.format(joint_name))
                return None
