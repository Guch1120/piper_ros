    ...
    def create(self):
        ...
        with _state_machine:
            ...
            OperatableStateMachine.add('wait enter key',
                                       ...
                                       transitions={'record': 'record joint', 'done': 'publish joint'},
                                       autonomy={'record': Autonomy.Off, 'done': Autonomy.Off})

            # x:370 y:174
            OperatableStateMachine.add('publish joint',
                                       PublishJoint(),
                                       transitions={'repeat': 'index increment', 'complete': 'finished'},
            ...
            OperatableStateMachine.add('record joint',
                                       RecordJoint(joint_state_topic='/joint_states', joint_names=['joint1','joint2','joint3','joint4','joint5','joint6','joint7']),
                                       transitions={'done': 'wait enter key'},
                                       autonomy={'done': Autonomy.Off},
                                       remapping={'joint_list': 'joint_list'})

            # x:375 y:336
            OperatableStateMachine.add('index increment',
                                       IncrementIndex(),
