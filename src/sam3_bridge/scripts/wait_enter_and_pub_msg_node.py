...
class WaitEnterAndPubMsgNode(Node):
    ...
    qキーで done をpublishして終了するROS 2ノード。
    """
    ...
    def __init__(self):
        ...
        self.get_logger().info('Press Enter to publish "{}". Press q to publish "{}" and quit.'.format(self._record_command,self._done_command))
        # Publisher接続待ち用に少し待つ
        time.sleep(0.5)
